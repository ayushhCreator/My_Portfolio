...
const Skills: React.FC = () => {
  const [displayStyle, setDisplayStyle] = useState<'cards' | 'badges' | 'circular' | 'cloud'>('badges');
  ...
  // Flatten all skills for badge/cloud display
        ...
        {allSkills.map((skill, index) => (
          ...
          >
            <span className="relative z-10 flex items-center gap-2">
              ...
              {skill.name}
              {skill.level >= 85 && <Award size={14} className="text-yellow-200" />}
            </span>
